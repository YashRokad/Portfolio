export const about = {
  ...
  portrait: '/media/profile_picture.png',
  wordmark: 'Yash Rokad',
  heroHeadline: 'I design the software that decides how somebody\u2019s Tuesday goes.',
  heroSub:
    'Four years inside enterprise verticals nobody puts on a showreel — payables, claims, shop floors, dock yards. The work is figuring out what the people using it are actually afraid of, then removing that.',
  ...
  ledger: [
    ...
    {
      label: 'My background',
      body: 'Four years in UI/UX, starting freelance before joining Simform Solutions as a design trainee and staying on as a UI/UX Designer. Most of that time has gone into operational software that people are required to use, not software they chose to open.',
    },
    {
      label: 'My approach',
  ...
  timeline: [
    { period: 'Oct 2023 — Present', role: 'UI/UX Designer', org: 'Simform Solutions', note: 'Converted from trainee to full-time. Designing operational software across enterprise verticals.' },
    { period: 'Feb 2023 — Jul 2023', role: 'UI/UX Design Trainee', org: 'Simform Solutions', note: 'Six-month apprenticeship — first structured exposure to enterprise UX and design process.' },
    { period: 'Sep 2022 — Feb 2023', role: 'Freelance UI/UX Designer', org: 'Independent', note: 'Early client work before joining Simform Solutions.' },
  ],
  skills: [
  ...
  capabilities: [
    ...
    artTone: '#c9c8c5', image: '/media/My Services/discovery & field research.png' },
    ...
    artTone: '#b6b5b2', image: '/media/My Services/service and journey design.png' },
    ...
    artTone: '#a3a29f', image: '/media/My Services/product design.png' },
    ...
    artTone: '#d6d5d2', image: '/media/My Services/Design system.png' },
    ...
    artTone: '#bfbebb', image: '/media/My Services/Pre-sales & Vision Work.png' },
  ],
  process: [
  ...
  stats: [
    { value: 4, suffix: '', label: 'Years designing operational software', note: 'Freelance, trainee, and full-time.' },
  ],
  personalNote:
